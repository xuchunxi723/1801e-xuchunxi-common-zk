 ...
 * @Description:中文字符串工具类
 * @author: xuchunxi
 * @date: 2020年4月27日 上午9:00:49
 */
public class ZHStringUtil {
	...
	public static String randomChineseString(){
		...
		highPos=(176+random.nextInt(40));//区码  0xa0打头  从第16区开始 即0xA0=11*16=176,16~55一级汉字 56~87二级汉字
		random=new Random();
		lowPos=161+random.nextInt(94);//位码 0xA0打头  范围1-94列
	...
	public static String getZHName(){
		...
		String string1 = str[RandNumUtil.random(0, str.length-1)];
		String string2 = getZHString(RandNumUtil.random(1, 2));
